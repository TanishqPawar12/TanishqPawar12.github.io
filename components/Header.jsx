...
import resume from "../src/assets/resume/curr CV.pdf"
import axios from 'axios'
import { Bounce, toast } from 'react-toastify'

import TanishqIcon from '../src/assets/TanishqIcon.png';
    ...
    return (
        <TransitionWrapper>
            <HStack p={3} justifyContent={'space-between'} alignItems={'center'} borderBottom={'1px solid rgb(54, 54, 54)'}>
                <Link to={'/'}>
                    <HStack>
                        <Image src="../src/assets/TanishqIcon.png" alt="Tanishq Icon" boxSize="30px" />
                        <Heading fontFamily={'Sofia'} fontSize={['1rem', 'md', 'xl', 'xl']}>Tanishq Pawar</Heading>
                    </HStack>
                </Link>
                    ...
                    <Menu>
                        ...
                        <MenuList bg={'#25282c'} border={'none'} >
                            <MenuItem width={'full'} borderRadius={'md'} _hover={{ bg: '#5141ff', color: 'white' }} bg={'#25282c'}>
                                <Link style={{ width: '100%' }} to="mailto:pawartanishq786@gmail.com" target='_blank'>
                                    <HStack>
